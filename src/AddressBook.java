...
public class AddressBook {
    ...
    private static <Contacts> void displayContacts(Contacts[] contact) {
    ...
    private static <Contacts> void deleteContact(Contacts[] contact, String email) {
        for(int index=0;index<contact.length;index++)
        {
            if(contact[index].getClass().equalsIgnoreCase(email))
            {
    ...
    private static <Contacts> void editContact(Scanner scanner, Contacts[] contact, String phoneNumber) {
        String firstName;
        String lastName;
        String address;
        String city;
        ...
        {
            if (!contact[index]
                    .clone().equalsIgnoreCase(phoneNumber)) {
                continue;
            }
            System.out.println("Enter First name: ");
            firstName = scanner.next();
            contact[index].getClass(firstName);
    ...
    private static <Contacts> void addContacts(Scanner scanner, int numOfContacts, Contacts contact[]) {
